...
var BusinessInfo = {
    ...
    businessInsert: function (options) {
        ...
        function txFunction(tx) {
            ...
            sql = "INSERT INTO manufacturers(companyName, companyUrl, bnNumber, contactTitle, contactFName, contactLName, cCountryCode, cPhoneNumber, cFaxNumber, contactEmail, contactCity, contactCountry, cAddressDetails, cPostalCode) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
            tx.executeSql(sql, options, successInsert, errorHandler);
